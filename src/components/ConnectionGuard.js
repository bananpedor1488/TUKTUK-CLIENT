...
const ConnectionGuard = ({ children }) => {
  ...
  const [connectionMessage, setConnectionMessage] = useState('Подключение к серверу...');

  useEffect(() => {
    if (!isConnected) {
      // Показываем разные сообщения во время попыток подключения
      const messages = [
      ...
      const interval = setInterval(() => {
        ...
        setConnectionMessage(messages[currentIndex]);
      }, 3000);
    ...
    <div className="loading-page">
      ...
      {!isMobile && (
        <div className="loading-branding">
          ...
          <div className="branding-dots">
            <div className="dot" style={{ width: 12, height: 12, background: 'rgba(208, 188, 255, 0.6)' }}></div>
            <div className="dot" style={{ width: 16, height: 16, background: 'rgba(208, 188, 255, 0.45)' }}></div>
            <div className="dot" style={{ width: 20, height: 20, background: 'rgba(208, 188, 255, 0.3)' }}></div>
          </div>
        </div>
      )}

      {/* Правая панель с загрузкой */}
      <div className="loading-form-container">
        <div className="loading-form-wrapper">
          ...
          <div className="loading-form-card">
            <div className="form-header">
              <h2 className="form-title">Подключение</h2>
              <p className="form-subtitle">Ожидание соединения с сервером...</p>
            </div>

            <div className="loading-content">
              <div className="loading-spinner-large"></div>
              <h3 className="loading-message">{connectionMessage}</h3>
              <p className="loading-description">
                Ожидание подключения к серверу. Пожалуйста, подождите...
              </p>
            </div>
