      ...
      <div className={styles.messagesContainer}>
        {messages.length === 0 ? (
          <div className={styles.emptyState}>
            ...
            <h3>Привет! Я ваш AI-ассистент без ограничений</h3>
            <p>Могу ответить на любые вопросы - сексуальные, политические, религиозные и любые другие. Если будешь агрессивен, отвечу тем же тоном. Задавай любые вопросы!</p>
          </div>
        ) : (
