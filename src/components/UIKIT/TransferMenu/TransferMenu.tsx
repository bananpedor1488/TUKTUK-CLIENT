...
const UserCard = styled(Box)<{ decoration?: any }>(({ theme, decoration }) => {
  ...
  return {
    ...
    background: decoration?.background
      ...
      : 'var(--theme-background, rgba(20, 20, 20, 0.4))',
    ...
    '& .MuiTypography-colorTextSecondary': {
      color: isLightBackground
        ? 'rgba(0, 0, 0, 0.6)'
        : 'var(--theme-text-secondary, #aaaaaa)',
    },
    '&:hover': {
      backgroundColor: 'var(--theme-background, rgba(40, 40, 40, 0.4))',
      cursor: 'pointer',
...
const TransferMenu: React.FC<TransferMenuProps> = ({ 
  ...
  const calculateAmountWithCommission = (desiredAmount: string) => {
    if (!desiredAmount || isNaN(Number(desiredAmount))) return 0;
  ...
  const handleTransferPoints = async () => {
    ...
    if (!transferData.amount) {
      ...
      isNaN(Number(transferData.amount)) ||
    ...
    if (includeCommissionMode) {
      ...
      } = calculateCommission(transferAmount.toString());
      commission = calcCommission;
      total = calcTotal;
      recipientAmount = calcRecipientAmount;
      ...
      {!transferSuccess ? (
            ...
            >
              ...
              <Button
                ...
                sx={{
                  ...
                  padding: { xs: '3px 6px', sm: '4px 12px' },
        ...
        <>
          <Box sx={{ textAlign: 'center', mb: 3 }}>
            ...
            <Typography
              variant='h5'
              sx={{ color: '#cfbcfb', fontWeight: 700, mb: 1 }}
            >
          ...
          <Box sx={{ 
            ...
            >
              <Typography
                variant='subtitle1'
                sx={{ color: '#cfbcfb', mb: 2, fontWeight: 600 }}
              >
